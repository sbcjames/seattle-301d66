...
// TO DO: Uncomment the following line of code to see the output in the browser console
...
// TO DO: After viewing the previous console.log(), return the code to a working state.
...
// TO DO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
//      object contructor for student.
// 2. What is "this" when joe.scopeArrow() is invoked?
//      it doesn't seem to be anything. A bunch of info about the page/window
// 3. Explain why "this" is different when an arrow function is used.
//    contextual this applies globally, where the arrow is just within this one block used within
